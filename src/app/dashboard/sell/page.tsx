...
export default function StartSellingPage() {
  ...
  const furnitureCategories: Record<string, string[]> = {
    'Living Room': ['Sofa', 'Coffee Table', 'TV Stand', 'Center Table', 'Bookshelf', 'Side Table', 'Ottoman', 'Recliner'],
    'Bedroom': ['Bed Frame', 'Mattress', 'Wardrobe', 'Dresser', 'Nightstand', 'Mirror', 'Chest of Drawers'],
    'Dining Room': ['Dining Table', 'Dining Chairs', 'Bar Stool', 'Buffet', 'China Cabinet', 'Bar Cart'],
    'Office': ['Office Desk', 'Office Chair', 'Filing Cabinet', 'Bookcase', 'Computer Table', 'Conference Table'],
    'Kitchen': ['Kitchen Island', 'Bar Stool', 'Kitchen Cabinet', 'Pantry', 'Kitchen Cart'],
    'Outdoor': ['Garden Chair', 'Outdoor Table', 'Swing', 'Garden Bench', 'Parasol', 'Outdoor Storage']
  };
  ...
  const materials = ['Wood', 'Metal', 'Plastic', 'Glass', 'Leather', 'Fabric', 'Rattan', 'Bamboo', 'Mixed Materials'];
  const colors = ['Brown', 'Black', 'White', 'Gray', 'Beige', 'Red', 'Blue', 'Green', 'Yellow', 'Multi-color'];
  ...
  const ProgressBar = () => (
    <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold text-gray-800">Step {currentStep} of {totalSteps}</h2>
            ...
            <div key={index} className="text-xs text-center flex-1">
              <div className={`w-8 h-8 rounded-full mx-auto mb-1 flex items-center justify-center text-xs font-bold
                ${index + 1 < currentStep ? 'bg-green-500 text-white' : 
                  index + 1 === currentStep ? 'bg-[#775522] text-white' : 'bg-gray-200 text-gray-500'}`}>
                {index + 1 < currentStep ? <FaCheck /> : index + 1}
              </div>
              <span className={`${index + 1 === currentStep ? 'text-[#775522] font-medium' : 'text-gray-500'}`}>
                {title}
              </span>
            </div>
          ))}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="bg-red-100 text-red-600 px-2 py-1 rounded-full text-xs font-medium">Required</span>
              </div>
              
              <p className="text-gray-600 mb-4">Add up to 10 high-quality photos. The first photo will be your main image.</p>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul className="text-blue-800 text-sm space-y-1">
                  ...
                  <li>• Lack of clear and high quality can make the listing rejected.</li>
                </ul>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800">Physical Details</h3>
              </div>
              ...
              {/* Dimensions */}
              <div className="mt-6">
                <h4 className="font-medium text-gray-800 mb-3">Dimensions (Optional)</h4>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800">Special Features</h3>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-medium text-gray-800 mb-2">Common Features to Consider:</h4>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm text-gray-600">
                    {['Reclining', 'Storage', 'Convertible', 'Memory Foam', 'Adjustable', 'Swivel', 'Foldable', 'Assembly Required', 'Washable Covers'].map(suggestion => (
                      <button
                        key={suggestion}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800">Delivery & Pickup Options</h3>
              </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <label className="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-[#775522] transition-colors">
                    ...
                    />
                    <div>
                      <span className="font-medium text-gray-800">Buyer Pickup</span>
                      <p className="text-sm text-gray-600">Buyer collects from your location</p>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-[#775522] transition-colors">
                    ...
                    />
                    <div>
                      <span className="font-medium text-gray-800">I Can Deliver</span>
                      <p className="text-sm text-gray-600">You deliver to buyer's location</p>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-[#775522] transition-colors">
                    ...
                    />
                    <div>
                      <span className="font-medium text-gray-800">Meet Halfway</span>
                      <p className="text-sm text-gray-600">Meet at a convenient location</p>
                    </div>
                  </label>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateFormData('delivery.deliveryAreas', e.target.value.split(', ').filter(area => area.trim()))}
                        placeholder="e.g., GRA, Mile 3, Eliozu"
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#775522]/30 focus:border-[#775522]"
                      />
                    </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-lg font-semibold text-gray-800">Listing Preview</h3>
              </div>
              ...
              <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                <div className="flex gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h4 className="text-lg font-semibold text-gray-900 mb-1">{formData.title || 'Untitled Listing'}</h4>
                    <p className="text-sm text-gray-600 mb-2">{formData.category} • {formData.subCategory}</p>
                    <p className="text-xl font-bold text-[#775522]">
                      ₦{formData.sellingPrice ? parseInt(formData.sellingPrice).toLocaleString() : '0'}
                      {formData.negotiable && <span className="text-sm font-normal text-gray-600 ml-1">(Negotiable)</span>}
                    </p>
                ...
                {formData.description && (
                  <p className="text-gray-700 text-sm mb-3">{formData.description.substring(0, 150)}...</p>
                )}
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800">Listing Summary</h3>
              </div>
            ...
            <div className="bg-gradient-to-r from-[#775522]/5 to-[#E8CEB0]/20 rounded-xl p-6 border border-[#775522]/20">
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">Before You Submit</h3>
                  <div className="space-y-2 text-sm text-gray-700">
                    <p>• Your listing will be reviewed and published within 24 hours</p>
                    <p>• All information provided should be accurate and truthful</p>
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <label htmlFor="terms" className="text-sm text-gray-700">
                  I agree to the <a href="#" className="text-[#775522] underline">Terms of Service</a> and confirm that all information is accurate
                </label>
              </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Start Selling Your Furniture</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Create a detailed listing to reach potential buyers in Lagos. 
            Follow our step-by-step process to showcase your furniture effectively.
          </p>
        </div>
