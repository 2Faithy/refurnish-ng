...
// --- ICON COMPONENTS ---
const Icon: React.FC<IconProps> = ({ children, className, title }) => (
  <span className={className} title={title}>
    {children}
  </span>
);

const FaHeart: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
...
const FaShoppingCart: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      ...
      <path d="M2.5 2.5h2.43L6 14h14l-1.5-8H6" />
    </svg>
  </Icon>
);

const FaTag: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
      ...
      strokeLinejoin="round"
    >
      <path d="M12.22 2h-.44A2 2 0 0 0 9 3.22L4.76 7.46A2 2 0 0 0 4 8.79V19a2 2 0 0 0 2 2h11.21a2 2 0 0 0 1.37-.58l5.44-5.44a2 2 0 0 0 0-2.83L14.07 3.22A2 2 0 0 0 12.22 2z" />
      <path d="M15 9h.01" />
    </svg>
  </Icon>
);

const FaMapMarkerAlt: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
      ...
      strokeLinejoin="round"
    >
      <path d="M12 21.7C17.3 17 22 13 22 10A10 10 0 0 0 12 0 10 10 0 0 0 2 10c0 3 4.7 7 10 11.7z" />
      <circle cx="12" cy="10" r="3" />
    </svg>
  </Icon>
);

const FaStar: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
const FaChevronLeft: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
const FaChevronRight: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
const FaChevronDown: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
const FaRegCheckCircle: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
const FaUserCircle: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
const FaShareAlt: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      ...
      <path d="m8.59 13.51 6.83 4.88" />
      <path d="m15.41 6.49-6.83 4.88" />
    </svg>
  </Icon>
);

const FaPlus: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
const FaMinus: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
const FaTruck: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      ...
      <path d="M10 18h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-3.95" />
...
const FaMoneyBillWave: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
const FaShieldAlt: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
const FaPhone: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
const FaWhatsapp: React.FC<IconProps> = (props) => (
  <Icon {...props}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
// --- CONSTANTS ---
const PRIMARY_COLOR = "#775522";
const SECONDARY_COLOR = "#E8CEB0";
const ACCENT_COLOR = "#9933BB";
const ACTION_COLOR = "#66BB44";
const BACKGROUND_COLOR = "#FDFBF7";
const TEXT_COLOR = "#5F7161";
const TEXT_DARK = "#110000";
...
const mockProducts: Product[] = [
  ...
  },
  {
    ...
    description:
      "Experience premium comfort with our high-back executive office chair. Upholstered in genuine leather with advanced lumbar support and synchro-tilt mechanism. Perfect for long working hours with its breathable mesh backing and polished chrome base.",
    features: [
...
const LogisticsAndProtection: React.FC<{ product: Product }> = ({
  product,
}) => (
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">
            {product.seller.responseTime} response
          </p>
        </div>
      </div>
      ...
      <div className="bg-beige-50 p-4 rounded-lg">
        ...
        <div className="flex flex-wrap gap-2">
          {product.deliveryAreas.map((area, index) => (
            <span
              key={index}
              className="px-3 py-1 bg-white border border-beige-200 rounded-full text-xs text-dark"
            >
              {area}
            </span>
          ))}
...
const ProductRatingsAndReviews: React.FC<{ product: Product }> = ({
  product,
}) => (
  <div className="bg-white p-6 rounded-2xl shadow-md border border-beige-200">
    ...
    <div className="flex items-baseline gap-4 mb-4">
      <span className="text-5xl font-bold text-brown-600">
...
export default function ProductDetailPage({ params }: ProductDetailPageProps) {
  ...
  const recommendedProducts = useMemo(
    () => mockProducts.filter((p) => p.id !== productId).slice(0, 3),
    [productId]
  );
  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-beige-50 flex flex-col justify-center items-center p-8">
        ...
        <a
          href="/shop"
          className="px-8 py-4 bg-brown-600 text-white rounded-xl hover:bg-brown-700 transition-colors font-semibold text-lg"
        >
          Back to Shop
        </a>
      </div>
    ...
    <div className="min-h-screen bg-beige-50 pt-20 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="mb-8 flex items-center text-sm text-gray-600">
          <a href="/" className="hover:text-brown-600 transition-colors">
            Home
          </a>
          <span className="mx-3">/</span>
          <a href="/shop" className="hover:text-brown-600 transition-colors">
            Shop
          </a>
          <span className="mx-3">/</span>
          <a
          ...
          <span className="mx-3">/</span>
          <span className="font-semibold text-brown-600 truncate">
            {product.name}
          </span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-md border border-beige-200">
              <h3 className="text-xl font-bold text-brown-600 mb-4">
                Key Features
              </h3>
        ...
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-beige-200">
              <h2 className="text-2xl font-bold text-brown-600 mb-6">
                Product Description
              </h2>
